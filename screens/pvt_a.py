...
def start_pvt_logic(label, test_duration_minutes=1, isi_min=2, isi_max=5, update_interval=10):
    """
    ...
    def pvt_key_press(event):
        ...
        if event.key() == Qt.Key.Key_Space:
            ...
            if state["trial_state"] == "active":
                ...
                save_to_csv(participant_id, "PVT_A", log_entry)
...
def create_experiment_PVT_screen_after(stack, trial_duration_minutes=10): # CHANGE here for trial duration
    ...
    next_button.clicked.connect(lambda: stack.setCurrentIndex(7))  # Move to PVT (Post)
    ...
    def finish_test():
        ...
        message_label.setTranslationKey("pvt_a_thank_you")
